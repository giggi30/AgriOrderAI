...
export default function AgriOrderDashboard({ user, onLogout }: AgriOrderDashboardProps) {
  ...
  useEffect(() => {
    ...
    // Gestione Installazione PWA (Moderno & Sicuro)
    ...
    window.addEventListener('beforeinstallprompt', (e) => {
      e.preventDefault();
      setDeferredPrompt(e);
      // Se abbiamo il prompt pronto e non è installato, mostriamo il banner
    ...
    // Se iOS e non installato, mostriamo il banner dopo un po'
  ...
  const handleInstallClick = async () => {
    ...
    if (isIOS) {
      ...
      // Fallback per Android se il prompt non è ancora pronto
      alert("Per installare l'App, tocca i tre puntini in alto a destra nel browser e seleziona 'Installa applicazione' o 'Aggiungi a schermata Home'.");
      setShowInstallBanner(false);
